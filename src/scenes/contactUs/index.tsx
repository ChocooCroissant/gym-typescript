  ...
  return (
    <section id='contactus' className='mx-auto w-5/6 pt-24'>
        ...
        >
            ...
            >
                <HText>
                    <span className=" text-primary-500">JOIN NOW</span><span> TO GET IN SHAPE</span>
                </HText>
                <p>
            ...
            <div className='mt-10 justify-between gap-8 md:flex'>
                ...
                >
                    <form
                        target='_blank'
                        onSubmit={onSubmit}
                        action='https://formsubmit.co/e599c5e7fb4d3208c7708ea45975d368'
                        method='POST'
                    >
                        <input 
                ...
                <motion.div
                    className='relative mt-16 mb-40 basis-2/5 md:mt-0'
                    initial="hidden"
                    whileInView="visible"
                    viewport={{once: true, amount: 0.5}}
                    transition={{delay: 0.2, duration: 0.5}}
